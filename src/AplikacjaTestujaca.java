...
public class AplikacjaTestujaca extends JFrame implements ActionListener, KeyListener {
    ...
    private boolean pokazujLiczbeZComboBoxa = false;
    ...
    public AplikacjaTestujaca(){
        ...
        panelWyswietlaczy.setAktualnyNapis(" ");
        panelWyswietlaczy.setCzyProjektowanie(false);
        panelWyswietlaczy.setCzyRysowacRamke(false);
        panelWyswietlaczy.wylaczLayout();
        panelWyswietlaczy.setCzyNiestandardoweRozstawienie(false);
        panelWyswietlaczy.ustawLiczbeNaWyswietlaczachIZwrocStatus(" ");
